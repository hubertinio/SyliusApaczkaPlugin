...
final class Order
{
    ...
    private static $dictServiceCode = array('UPS_K_STANDARD', 'UPS_K_EX_SAV', 'UPS_K_EX', 'UPS_K_EXP_PLUS', 'DPD_CLASSIC', 'DHLSTD', 'DHL12', 'DHL09', 'DHL1722', 'UPS_Z_STANDARD', 'UPS_Z_EX_SAV', 'UPS_Z_EX', 'UPS_Z_EXPEDITED', 'TNT', 'FEDEX', 'KEX_EXPRESS', 'POCZTA_POLSKA', 'POCZTA_POLSKA_E24', 'SIODEMKA_STD');
